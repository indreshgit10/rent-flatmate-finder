...
const Home = () => {
  ...
  return (
    <div style={{
      ...
      {/* Hero Section */}
      <section className="hero-section" style={{ maxWidth: '1200px', margin: '6rem auto 4rem', textAlign: 'center', padding: '0 2rem' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 2rem' }}>
        <div className="home-card-grid">
          {/* Card 1 */}
          <div className="home-card" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '8px', padding: '1rem', cursor: 'pointer', transition: 'background-color 0.2s' }}
      ...
      <section className="grow-network-section">
        <div style={{ flex: 1 }}>
          <h2 className="grow-network-title" style={{ fontWeight: 700, lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-1px' }}>
        ...
        <div style={{ flex: 1.2, position: 'relative' }}>
          <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '1.5rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
